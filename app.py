    ...
    if request.method == "POST":
        if 'product_name' in request.form:
            ...
            try:
                ...
                return f"There was an issue while adding a new Product: {str(e)}"
            ...
            try:
                ...
                return f"There was an issue while adding a new Location: {str(e)}"

    # Fetch products and locations to display
...
def signup():
    ...
    # Render signup form for GET request
